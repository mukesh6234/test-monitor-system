        ...
        <Box sx={{ mx: 'auto', maxWidth: 400 }}>
          ...
          <form noValidate autoComplete='off' onSubmit={handleSubmit(onSubmit)}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Link href='/' passHref>
                <IconButton component='a' sx={{ color: '#497ce2' }} onClick={e => e.preventDefault()}>
                  <Icon icon='bxl:facebook-circle' />
                </IconButton>
              </Link>
              <Link href='/' passHref>
                <IconButton component='a' sx={{ color: '#1da1f2' }} onClick={e => e.preventDefault()}>
              ...
              <Link href='/' passHref>
                <IconButton component='a' sx={{ color: '#db4437' }} onClick={e => e.preventDefault()}>
